...
const GlowingMesh: React.FC<GlowingMeshProps> = ({ className = '', withMotion = false }) => {
  return (
    <div className={`absolute inset-0 overflow-hidden -z-10 ${className}`}>
      <motion.div
        ...
        transition={withMotion ? { ...baseTransition, duration: 14 } : undefined}
      />
      ...
      <motion.div
        ...
        transition={withMotion ? { ...baseTransition, duration: 13 } : undefined}
      />
      ...
      <motion.div
        ...
        transition={withMotion ? { ...baseTransition, duration: 16 } : undefined}
      />
      ...
      <motion.div
        ...
        transition={withMotion ? { ...baseTransition, duration: 15 } : undefined}
      />
    </div>
  );
};
