...
import InsetGlow from '@/components/cedar-os/ornaments/InsetGlow';
...
export const CollapsedButton = forwardRef<HTMLDivElement, CollapsedChatButtonProps>(
  ({ side = 'right', label, onClick, layoutId, position = 'fixed' }, ref) => {
    ...
    const [bottomOffset, setBottomOffset] = useState<number>(() => getInitialOffset());
    ...
    const [sideOffset, setSideOffset] = useState<number>(() => getInitialSideOffset());
